        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 pb-12 border-b border-gray-100">
              ...
              <div className="flex items-center gap-3 pt-2">
                {socialLinks.map((s) => (
                  <a
                    ...
                    aria-label={s.name}
                    className="w-9 h-9 rounded-2xl border border-gray-200 flex items-center justify-center text-gray-600 hover:border-[#002798] hover:text-[#002798] hover:scale-110 active:scale-95 transition-all"
                  >
                    {s.icon}
                  </a>
                ))}
            ...
            <div className="md:col-span-2 space-y-3">
              ...
              <ul className="space-y-3 text-xs text-gray-600">
                <li><Link href="/about" className="hover:text-[#002798] transition-colors">About Us</Link></li>
                <li><Link href="/#contact-info" className="hover:text-[#002798] transition-colors">{t.footer.contactUs}</Link></li>
                <li><Link href="/about#team" className="hover:text-[#002798] transition-colors">Team &amp; Partners</Link></li>
              </ul>
            </div>
            ...
            <div className="md:col-span-4 space-y-3">
              ...
              <ul className="space-y-3 text-xs text-gray-600">
                ...
                <li className="flex items-center gap-2 text-gray-500 text-[11px]">
                  <svg className="w-3.5 h-3.5 text-[#002798] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-gray-500">
            <p>© 2026 IDEA Institut. {t.footer.copyright}</p>
            <div className="flex gap-6">
              <Link href="/about" className="hover:text-gray-900 transition-colors">Privacy Policy</Link>
              <Link href="/about" className="hover:text-gray-900 transition-colors">Terms of Service</Link>
            </div>
          </div>
        </div>
      </div>
