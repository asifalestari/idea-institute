...
const footerLinks = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Study & Work', href: '/opportunities/study-and-work' },
...
export default function Footer() {
  return (
    <footer style={{ background: '#002798' }} className="text-white">
      {/* Main Footer */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm leading-relaxed mb-5" style={{ color: 'rgba(255,255,255,0.7)' }}>
              ...
              Australia, Jerman, dan negara OECD pilihan.
            </p>
          ...
          {footerLinks.map((col) => (
            <div key={col.title}>
              <h3 className="font-bold text-sm mb-4 tracking-wide" style={{ color: '#F4A019' }}>
      ...
      >
        <div className="container-section flex flex-col sm:flex-row items-center justify-between gap-3 text-xs" style={{ color: 'rgba(255,255,255,0.5)' }}>
          <p>© 2025 IDEA Institut. All rights reserved.</p>
          <div className="flex gap-4">
            <a href={contactInfo.whatsapp} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
